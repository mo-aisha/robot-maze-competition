...
const char straight_option[] PROGMEM = "Straight";
const char left_option[] PROGMEM = "Left";
const char right_option[] PROGMEM = "Right";
const char left_right_option_line1[] PROGMEM = "Left or";
const char left_right_option_line2[] PROGMEM = "Right";
...
void loop()
{
  while (1)
  {
    ...
    if (sensors[0] > 100)
      found_left = 1;
      OrangutanLCD::clear();
      OrangutanLCD::printFromProgramSpace(left_option);
      delay(100);
    if (sensors[4] > 100)
      found_right = 1;
      OrangutanLCD::clear();
      OrangutanLCD::printFromProgramSpace(right_option);
      delay(100);
    ...
    if (sensors[1] > 200 || sensors[2] > 200 || sensors[3] > 200)
      found_straight = 1;
      OrangutanLCD::clear();
      OrangutanLCD::printFromProgramSpace(straight_option);
      delay(100);   
  }
